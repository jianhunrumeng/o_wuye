                  ...
                  <div class="span8">
                    <form id="form1" name="form1">
                      <div class="form-horizontal pull-right">
                        <select name="type" id="search-type" class="input-small" style="width: 100px">
                        ...
                        <input id="n-keyword-input" name="n-keywords" class="input-medium" placeholder="请输入关键词" type="text">
                          <input id="property_company_name" name="property_company_name" class="input-medium" placeholder="请搜索物业公司名称" type="text" style="display: none;" data-id="">
                            <input type="button" class="btn" id="search" onclick="qryUser();" value="查询"></div>
                          </form>
                        </div>
                      </div>
                      <div class="box-content">
                        <div class="row-fluid">
                          <div class="span12 control-group">
                            <div class="span7">
                              <a class="btn" href="addUserInfo.jsp">
                                <i class="icon-plus"></i>新增用户</a>
                              <a class="btn" href="javascript:removeAllUser();">
                                <i class="icon-plus"></i>删除用户</a>
