 ...
 * {@link com.ffcs.fmw.aas.author.service.ResourceService}.
 */
public class RtManagerException extends java.lang.RuntimeException {
     ...
     * @param clazz   Class： 类.calss，或实例.getClass()
     * @param method  String：异常方法名字
     * @param code    String：本方法内部唯一编码
     */
     ...
     * Map{@id:"123"});
     * 结果：通用提示界面提示信息为：XX对象为空,ID:123
     *
     * @param message String：提示消息.
     * @param clazz   Class： 类.calss，或实例.getClass()
     * @param method  String：异常方法名字
     * @param code    String：本方法内部唯一编码
     * @param dataMap Map:过程数据保存，会在提示界面展示，
     */
     ...
     * @param method  String：异常方法名字
     * @param code    String：本方法内部唯一编码
     * @param params  Object...: 可变数量参数，过程数据保存，必须为偶数，奇数代表键值，偶数代表实际数据，会在提示界面展示
     */
    public RtManagerException(String message, Class clazz, String method, String code,
                              final Object... params) {
        super(message);
        ...
        if (sum > 1) {
            ...
            for (int i = 0, iLength = rsum; i < iLength; i++) {
                dataMap.put(params[i * 2], params[i * 2 + 1]);
            }
            this.setDataMap(dataMap);
        }
    }
     ...
     * @param message   the throwable message.
     * @param throwable the parent of this Throwable.
     * @param String    the throwable code.
     */
    ...
    public String getMessage() {
        ...
        if (retMsg != null && this.dataMap != null && this.dataMap.size() > 0) {
            try {
