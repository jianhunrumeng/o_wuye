package com.wuye.common.util.numeric;
...
/**
 * @版权：福富软件 版权所有 (c) 2015
 * @文件：com.ffcs.crm.common.util.numeric.NumericUtil.java
 * @所含类：NumericUtil
 * @author: chaijinchun
 * @version: V1.0
 * @see:
 * @创建日期：2015-9-20
 * @功能说明：实现数字及数字格式化的基本功能<br> <&nbsp>包括：精确的加减乘除法、金额数字转 成中文等。
 * @修改记录： =============================================================<br>
 * 日期:2015-9-20 chaijinchun 创建
 * =============================================================<br>
 */
public class NumericUtil {
     ...
     * @author: chaijinchun
     * @修改记录： ==============================================================<br>
     * 日期:2015-9-21 chaijinchun 创建方法，并实现其功能
     * ==============================================================<br>
     */
     ...
     * @author: chaijinchun
     * @修改记录： ==============================================================<br>
     * 日期:2004-05-26 chaijinchun 创建方法，并实现其功能
     * ==============================================================<br>
     */
     ...
     *
     * @param num    待转换的double数
     * @param digits 小数点后的位数
     * @return String 指定小数位数的字符串
     * @author: chaijinchun
     * @修改记录： ==============================================================<br>
     * 日期2004-05-26 chaijinchun 创建方法，并实现其功能
     * ==============================================================<br>
     */
     ...
     * @author: chaijinchun
     * @修改记录： ==============================================================<br>
     * 日期:2015-7-22 chaijinchun 创建方法，并实现其功能
     * ==============================================================<br>
     */
     ...
     * Long转long
     */
    public static long toLongValue(final Long l) {
        long ret = 0;
        if (l != null) {
            ret = l.longValue();
        }
