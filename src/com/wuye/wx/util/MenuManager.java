...
import com.wuye.wx.pojo.CommonButton;
...
public class MenuManager {
    ...
    public static void main(String[] args) {
        ...
        if (null != accToken) {
            // 调用接口创建菜单
            int result = WeixinUtil.createMenu(getMenu(), accToken);
    ...
    private static Menu getMenu() {
        ...
        /**
         * 这是公众号 xiaoqrobot 目前的菜单结构，每个一级菜单都有二级菜单项<br>
         *
         * 在某个一级菜单下没有二级菜单的情况，menu 该如何定义呢？<br>
         * 比如，第三个一级菜单项不是“更多体验”，而直接是“幽默笑话”，那么 menu 应该这样定义：<br>
